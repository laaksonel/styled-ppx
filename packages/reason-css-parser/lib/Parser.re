...
and _legacy_linear_gradient_arguments = [%value.rec "[ <angle> | <side-or-corner> ]? ',' <color-stop-list>"]
...
and _legacy_radial_gradient_arguments = [%value.rec "[ <position> ',' ]? [ [ <-legacy-radial-gradient-shape> || <-legacy-radial-gradient-size> | [ <length> | <percentage> ]{2} ] ',' ]? <color-stop-list>"]
...
and _webkit_gradient_color_stop = [%value.rec "from( <color> ) | color-stop( [ <alpha-value> | <percentage> ] ',' <color> ) | to( <color> )"]
and _webkit_gradient_point = [%value.rec "[ 'left' | 'center' | 'right' | <length-percentage> ] [ 'top' | 'center' | 'bottom' | <length-percentage> ]"]
...
and length_interpolation = [%value.rec "<lenght> | <interpolation>"]
...
and bg_position = [%value.rec "'left' | 'center' | 'right' | 'top' | 'bottom' | <length-percentage> | [ 'left' | 'center' | 'right' | <length-percentage> ] [ 'top' | 'center' | 'bottom' | <length-percentage> ] | [ 'center' | [ 'left' | 'right' ] [ <length-percentage> ]? ] && [ 'center' | [ 'top' | 'bottom' ] [ <length-percentage> ]? ]"]
and bg_size = [%value.rec "[ <length-percentage> | 'auto' ]{1,2} | 'cover' | 'contain'"]
...
and color = [%value.rec "<rgb()> | <rgba()> | <hsl()> | <hsla()> | <hex-color> | <named-color> | 'currentColor' | <deprecated-system-color>"]
...
and font_stretch_absolute = [%value.rec "'normal' | 'ultra-condensed' | 'extra-condensed' | 'condensed' | 'semi-condensed' | 'semi-expanded' | 'expanded' | 'extra-expanded' | 'ultra-expanded' | <percentage>"]
...
and function_conic_gradient = [%value.rec "conic-gradient( [ 'from' <angle> ]? [ 'at' <position> ]? ',' <angular-color-stop-list> )"]
...
and function_drop_shadow = [%value.rec "drop-shadow( [ <length> ]{2,3} [ <color> ]? )"]
...
and function_fit_content = [%value.rec "fit-content( <length> | <percentage> )"]
and function_grayscale = [%value.rec "grayscale( <number-percentage> )"]
and function_hsl = [%value.rec " hsl( <hue> <percentage> <percentage> [ '/' <alpha-value> ]? )
  | hsl( <hue> ',' <percentage> ',' <percentage> [ ',' <alpha-value> ]? )"]
and function_hsla = [%value.rec " hsla( <hue> <percentage> <percentage> [ '/' <alpha-value> ]? )
...
and function_inset = [%value.rec "inset( [ <length-percentage> ]{1,4} [ 'round' <'border-radius'> ]? )"]
and function_invert = [%value.rec "invert( <number-percentage> )"]
and function_leader = [%value.rec "leader( <leader-type> )"]
and function_linear_gradient = [%value.rec "linear-gradient( [ <angle> | 'to' <side-or-corner> ]? ',' <color-stop-list> )"]
...
and function_minmax = [%value.rec "minmax( [ <length> | <percentage> | 'min-content' | 'max-content' | 'auto' ] ',' [ <length> | <percentage> | <flex-value> | 'min-content' | 'max-content' | 'auto' ] )"]
...
and function_polygon = [%value.rec "polygon( [ <fill-rule> ]? ',' [ <length-percentage> <length-percentage> ]# )"]
and function_radial_gradient = [%value.rec "radial-gradient( [ <ending-shape> || <size> ]? [ 'at' <position> ]? ',' <color-stop-list> )"]
and function_repeating_linear_gradient = [%value.rec "repeating-linear-gradient( [ <angle> | 'to' <side-or-corner> ]? ',' <color-stop-list> )"]
and function_repeating_radial_gradient = [%value.rec "repeating-radial-gradient( [ <ending-shape> || <size> ]? [ 'at' <position> ]? ',' <color-stop-list> )"]
and function_rgb = [%value.rec "rgb( [ <percentage> ]{3} [ '/' <alpha-value> ]? )
  | rgb( [ <number> ]{3} [ '/' <alpha-value> ]? )
  | rgb( [ <percentage> ]#{3} [ ',' <alpha-value> ]? )
  | rgb( [ <number> ]#{3} [ ',' <alpha-value> ]? )"]
and function_rgba = [%value.rec "rgba( [ <percentage> ]{3} [ '/' <alpha-value> ]? ) | rgba( [ <number> ]{3} [ '/' <alpha-value> ]? ) | rgba( [ <percentage> ]#{3} [ ',' <alpha-value> ]? ) | rgba( [ <number> ]#{3} [ ',' <alpha-value> ]? )"]
and function_rotate = [%value.rec "rotate( <angle> | <zero> )"]
and function_rotate3d = [%value.rec "rotate3d( <number> ',' <number> ',' <number> ',' [ <angle> | <zero> ] )"]
...
and function_skew = [%value.rec "skew( [ <angle> | <zero> ] ',' [ <angle> | <zero> ]? )"]
...
and function_translate = [%value.rec "translate( <length-percentage> ',' [ <length-percentage> ]? )"]
and function_translate3d = [%value.rec "translate3d( <length-percentage> ',' <length-percentage> ',' <length> )"]
...
and inflexible_breadth = [%value.rec "<length> | <percentage> | 'min-content' | 'max-content' | 'auto'"]
...
and mask_position = [%value.rec "[ <length-percentage> | 'left' | 'center' | 'right' ] [ <length-percentage> | 'top' | 'center' | 'bottom' ]?"]
...
and position = [%value.rec "[ 'left' | 'center' | 'right' ] || [ 'top' | 'center' | 'bottom' ] | [ 'left' | 'center' | 'right' | <length-percentage> ] [ 'top' | 'center' | 'bottom' | <length-percentage> ]? | [ 'left' | 'right' ] <length-percentage> && [ 'top' | 'bottom' ] <length-percentage>"]
...
and property__ms_content_zoom_snap_points = [%value.rec "snapInterval( <percentage> ',' <percentage> ) | snapList( [ <percentage> ]# )"]
...
and property__ms_scroll_snap_points_x = [%value.rec "snapInterval( <length-percentage> ',' <length-percentage> ) | snapList( [ <length-percentage> ]# )"]
and property__ms_scroll_snap_points_y = [%value.rec "snapInterval( <length-percentage> ',' <length-percentage> ) | snapList( [ <length-percentage> ]# )"]
...
and property__webkit_box_reflect = [%value.rec "[ 'above' | 'below' | 'right' | 'left' ]? [ <length> ]? [ <image> ]?"]
...
and property__webkit_mask_box_image = [%value.rec "[ <url> | <gradient> | 'none' ] [ [ <length-percentage> ]{4} [ <-webkit-mask-box-repeat> ]{2} ]?"]
...
and property__webkit_mask_position_x = [%value.rec "[ <length-percentage> | 'left' | 'center' | 'right' ]#"]
and property__webkit_mask_position_y = [%value.rec "[ <length-percentage> | 'top' | 'center' | 'bottom' ]#"]
...
and property_azimuth = [%value.rec "<angle> | [ 'left-side' | 'far-left' | 'left' | 'center-left' | 'center' | 'center-right' | 'right' | 'far-right' | 'right-side' ] || 'behind' | 'leftwards' | 'rightwards'"]
...
and property_background_position_x = [%value.rec "[ 'center' | [ 'left' | 'right' | 'x-start' | 'x-end' ]? [ <length-percentage> ]? ]#"]
and property_background_position_y = [%value.rec "[ 'center' | [ 'top' | 'bottom' | 'y-start' | 'y-end' ]? [ <length-percentage> ]? ]#"]
...
and property_border_bottom_left_radius = [%value.rec "[ <length-percentage> ]{1,2}"]
and property_border_bottom_right_radius = [%value.rec "[ <length-percentage> ]{1,2}"]
...
and property_border_end_end_radius = [%value.rec "[ <length-percentage> ]{1,2}"]
and property_border_end_start_radius = [%value.rec "[ <length-percentage> ]{1,2}"]
...
and property_border_image_width = [%value.rec "[ <length-percentage> | <number> | 'auto' ]{1,4}"]
...
and property_border_radius = [%value.rec "[ <length-percentage> ]{1,4} [ '/' [ <length-percentage> ]{1,4} ]?"]
...
and property_border_start_end_radius = [%value.rec "[ <length-percentage> ]{1,2}"]
and property_border_start_start_radius = [%value.rec "[ <length-percentage> ]{1,2}"]
...
and property_border_top_left_radius = [%value.rec "[ <length-percentage> ]{1,2}"]
and property_border_top_right_radius = [%value.rec "[ <length-percentage> ]{1,2}"]
...
and property_font_size = [%value.rec "<absolute-size> | <relative-size> | <length-percentage>"]
and property_font_size_adjust = [%value.rec "'none' | <number>"]
and property_font_smooth = [%value.rec "'auto' | 'never' | 'always' | <absolute-size> | <length>"]
and property_font_stretch = [%value.rec "<font-stretch-absolute>"]
and property_font_style = [%value.rec "'normal' | 'italic' | 'oblique' [ <angle> ]?"]
...
and property_height = [%value.rec "'auto' | <length> | <percentage> | 'min-content' | 'max-content' | fit-content( <length-percentage> )"]
and property_hyphens = [%value.rec "'none' | 'manual' | 'auto'"]
and property_image_orientation = [%value.rec "'from-image' | <angle> | [ <angle> ]? 'flip'"]
...
and property_line_height = [%value.rec "'normal' | <number> | <length> | <percentage>" ]
...
and property_mask_border_width = [%value.rec "[ <length-percentage> | <number> | 'auto' ]{1,4}"]
...
and property_max_height = [%value.rec "'auto' | <length> | <percentage> | 'min-content' | 'max-content' | fit-content( <length-percentage> )"]
and property_max_inline_size = [%value.rec "<'max-width'>"]
and property_max_lines = [%value.rec "'none' | <integer>"]
and property_max_width = [%value.rec "<length> | <percentage> | 'none' | 'max-content' | 'min-content' | fit-content( <length-percentage> ) | 'fill-available' | <-non-standard-width>"]
and property_min_block_size = [%value.rec "<'min-width'>"]
and property_min_height = [%value.rec "'auto' | <length> | <percentage> | 'min-content' | 'max-content' | fit-content( <length-percentage> )"]
...
and property_offset_path = [%value.rec "'none' | ray( <angle> && [ <size> ]? && [ 'contain' ]? ) | <path()> | <url> | <basic-shape> || <geometry-box>"]
...
and property_pause_after = [%value.rec "<time> | 'none' | 'x-weak' | 'weak' | 'medium' | 'strong' | 'x-strong'"]
and property_pause_before = [%value.rec "<time> | 'none' | 'x-weak' | 'weak' | 'medium' | 'strong' | 'x-strong'"]
...
and property_rest_after = [%value.rec "<time> | 'none' | 'x-weak' | 'weak' | 'medium' | 'strong' | 'x-strong'"]
and property_rest_before = [%value.rec "<time> | 'none' | 'x-weak' | 'weak' | 'medium' | 'strong' | 'x-strong'"]
and property_right = [%value.rec "<length> | <percentage> | 'auto'"]
and property_rotate = [%value.rec "'none' | <angle> | [ 'x' | 'y' | 'z' | [ <number> ]{3} ] && <angle>"]
...
and property_scroll_padding = [%value.rec "[ 'auto' | <length-percentage> ]{1,4}"]
and property_scroll_padding_block = [%value.rec "[ 'auto' | <length-percentage> ]{1,2}"]
and property_scroll_padding_block_end = [%value.rec "'auto' | <length-percentage>"]
and property_scroll_padding_block_start = [%value.rec "'auto' | <length-percentage>"]
and property_scroll_padding_bottom = [%value.rec "'auto' | <length-percentage>"]
and property_scroll_padding_inline = [%value.rec "[ 'auto' | <length-percentage> ]{1,2}"]
and property_scroll_padding_inline_end = [%value.rec "'auto' | <length-percentage>"]
and property_scroll_padding_inline_start = [%value.rec "'auto' | <length-percentage>"]
...
and property_scroll_snap_points_x = [%value.rec "'none' | repeat( <length-percentage> )"]
and property_scroll_snap_points_y = [%value.rec "'none' | repeat( <length-percentage> )"]
...
and property_text_decoration_thickness = [%value.rec "'auto' | 'from-font' | <length> | <percentage>"]
...
and property_text_indent = [%value.rec "<length-percentage> && [ 'hanging' ]? && [ 'each-line' ]?"]
...
and property_text_underline_offset = [%value.rec "'auto' | <length> | <percentage>"]
...
and property_transform_origin = [%value.rec "<length-percentage> | 'left' | 'center' | 'right' | 'top' | 'bottom' | [ [ <length-percentage> | 'left' | 'center' | 'right' ] && [ <length-percentage> | 'top' | 'center' | 'bottom' ] ] [ <length> ]?"]
...
and property_translate = [%value.rec "'none' | <length-percentage> [ <length-percentage> [ <length> ]? ]?"]
...
and property_vertical_align = [%value.rec "'baseline' | 'sub' | 'super' | 'text-top' | 'text-bottom' | 'middle' | 'top' | 'bottom' | <percentage> | <length>"]
...
and property_voice_pitch = [%value.rec "<frequency> && 'absolute' | [ 'x-low' | 'low' | 'medium' | 'high' | 'x-high' ] || [ <frequency> | <semitones> | <percentage> ]"]
and property_voice_range = [%value.rec "<frequency> && 'absolute' | [ 'x-low' | 'low' | 'medium' | 'high' | 'x-high' ] || [ <frequency> | <semitones> | <percentage> ]"]
and property_voice_rate = [%value.rec "[ 'normal' | 'x-slow' | 'slow' | 'medium' | 'fast' | 'x-fast' ] || <percentage>"]
...
and property_width = [%value.rec "'auto' | <length> | <percentage> | 'min-content' | 'max-content' | fit-content( <length-percentage> )"]
and property_will_change = [%value.rec "<length_interpolation>"]
...
and shadow = [%value.rec "[ 'inset' ]? [ <length> | <interpolation> ]{4} [ <color> | <interpolation> ]?"]
and shadow_t = [%value.rec "[ <length> | <interpolation> ]{3} [ <color> | <interpolation> ]?"]
and shape = [%value.rec "rect( <top> ',' <right> ',' <bottom> ',' <left> ) | rect( <top> <right> <bottom> <left> )"]
and shape_box = [%value.rec "<box> | 'margin-box'"]
and shape_radius = [%value.rec "<length-percentage> | 'closest-side' | 'farthest-side'"]
and side_or_corner = [%value.rec "[ 'left' | 'right' ] || [ 'top' | 'bottom' ]"]
and single_animation = [%value.rec "<time> || <timing-function> || <time> || <single-animation-iteration-count> || <single-animation-direction> || <single-animation-fill-mode> || <single-animation-play-state> || [ 'none' | <keyframes-name> ]"]
...
and single_transition = [%value.rec "[ 'none' | <single-transition-property> ] || <time> || <timing-function> || <time>"]
and single_transition_property = [%value.rec "'all' | <custom-ident>"]
and size = [%value.rec "'closest-side' | 'farthest-side' | 'closest-corner' | 'farthest-corner' | <length> | [ <length-percentage> ]{2}"]
...
and track_breadth = [%value.rec "<length-percentage> | <flex-value> | 'min-content' | 'max-content' | 'auto'"]
...
and track_minmax = [%value.rec "minmax( <track-breadth> ',' <track-breadth> ) | 'auto' | <track-breadth> | fit-content( <length-percentage> )"]
and track_repeat = [%value.rec "repeat( <positive-integer> ',' [ [ <line-names> ]? <track-size> ]+ [ <line-names> ]? )"]
and track_size = [%value.rec "<track-breadth> | minmax( <inflexible-breadth> ',' <track-breadth> ) | fit-content( <length> | <percentage> )"]
