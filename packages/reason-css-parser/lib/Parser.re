...
and calc_value = [%value.rec "<number> | <percentage> | '(' <calc-sum> ')'"]
...
and property_width = [%value.rec "'auto' | <length> | <percentage> | 'min-content' | 'max-content' | fit-content( <length-percentage> ) | <calc-value>"]
