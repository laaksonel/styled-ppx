...
module NestedPropreties = {
  ...
  let styles =
    CssJs.style(. [|
      CssJs.label("NestedPropreties"),
      CssJs.selector({js|& span|js}, [|CssJs.color(CssJs.red)|]),
      CssJs.selector(
        {js|& button:hover|js},
        [|CssJs.unsafe("cursor", "pointer")|],
      ),
      CssJs.selector({js|& p:not(.active)|js}, [|CssJs.display(`none)|]),
      CssJs.selector(
        {js|& a[target = "_blank"]|js},
        [|CssJs.color(CssJs.red)|],
      ),
      CssJs.selector(
        {js|& input[type = "button"]|js},
