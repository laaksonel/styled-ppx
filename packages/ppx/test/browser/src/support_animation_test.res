...
let testData = [
  (
    ...
    CssJs.style(. [CssJs.unsafe("animationName", "slidein")]),
  ),
  (
    "animation-duration",
    %cx("animation-duration: 3s"),
    CssJs.style(. [CssJs.unsafe("animationDuration", "3s")]),
  ),
  (
  ...
  (
    ...
    CssJs.style(. [CssJs.unsafe("animationDelay", "3s")]),
  ),
  (
    "animation-direction",
  ...
  (
    ...
    CssJs.style(. [CssJs.unsafe("animationIterationCount", "1")]),
  ),
  (
    "animation-iteration-count",
